...
//por higekun · http://answers.unity3d.com/questions/463207/how-do-you-make-a-custom-handle-respond-to-the-mou.html
public class MyHandles
{
    ...
    public static Vector3 ClickHandle(Vector3 position, float handleSize, Handles.DrawCapFunction capFunc, Color colorSelected, out DragHandleResult result)
    {
        ...
        switch (Event.current.GetTypeForControl(id))
        {
            ...
            case EventType.Repaint:
                ...
                if (id == GUIUtility.hotControl && s_HandleSelected)
